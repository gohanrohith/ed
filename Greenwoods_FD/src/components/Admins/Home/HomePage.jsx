      ...
      <div style={headerContainer}>
        <h1 style={headerStyle}>
          {selectedStudent
            ...
            : selectedSection
            ? `Students in Grade ${selectedClass} - Section ${selectedSection}`
            : selectedClass
            ? `Sections in Grade ${selectedClass}`
            : 'Student Directory'}
        </h1>
        <div>
          {selectedStudent ? (
            ...
            <Button onClick={handleBackToSections} style={backButtonStyle}>
      ...
      {!loading && !error && (
        selectedStudent ? (
          ...
          <Row gutter={[16, 16]} style={rowStyle}>
            {groupedStudents[selectedClass][selectedSection].map((student) => (
          ...
          <Row gutter={[16, 16]} style={rowStyle}>
            {Object.keys(groupedStudents[selectedClass]).map((sectionName) => (
              <Col key={sectionName} xs={24} sm={12} md={8} lg={6}>
                <motion.div
                  whileHover={{ scale: 1.05, rotate: 2 }}
                  whileTap={{ scale: 0.95, rotate: -2 }}
                  initial={{ opacity: 0, y: 20 }}
                ...
                >
                  ...
                  >
                    <h3 style={titleStyle}>Section {sectionName}</h3>
                    <p style={studentCountStyle}>
                      {groupedStudents[selectedClass][sectionName].length} Students
                    </p>
                  </div>
                </motion.div>
              </Col>
              ...
              <Col key={className} xs={24} sm={12} md={8} lg={6}>
                ...
                >
                  ...
                  >
                    ...
                    <p style={studentCountStyle}>
                      {Object.keys(groupedStudents[className]).length} Sections
                    </p>
                  </div>
                </motion.div>
              </Col>
